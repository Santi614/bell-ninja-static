...
function getsch() {
    ...
    if (n == 1) {
        ...
        if (timex >= 1.00 && timex < 8.00) {
            ...
            bmessage = "Period 5a (Either Free Period or Lunch) - 11:20 to 11:50"
            period = "Period 5a"
            var timel = "11:50:00";
            classis = true;
            ...
            bmessage = "Period 5b (Either Free Period or Lunch) - 11:55 to 12:25"
            period = "Period 5b"
            var timel = "12:25:00";
            classis = true;
            ...
            bmessage = "Period 6a (MS Class) - 12:30 to 1:00"
            period = "Period 6a"
            var timel = "13:00:00";
            classis = false;
            ...
            bmessage = "Period 6b (MS Free Time) - 1:05 to 1:35"
            period = "Period 6b"
            var timel = "13:35:00";
            classis = false;
...
<<<<<<< HEAD
    ...
    ///// Wednesday (Odd Block)
    if (n == 3) {
        dayweek = "Wednesday (special even)"
=======
...
>>>>>>> parent of a5b9963... f
    ...
    if (n == 4) {
        ...
        if (timex >= 1.00 && timex < 8.00) {
            ...
            bmessage = "Period 5a (Either Free Period or Lunch) - 11:25 to 11:55"
            period = "Period 5a"
            var timel = "11:55:00";
            classis = true;
            ...
            bmessage = "Period 5b (Either Free Period or Lunch) - 12:00 to 12:30"
            period = "Period 5b"
            var timel = "12:30:00";
            classis = true;
            ...
            bmessage = "Period 6a (MS Class) - 12:35 to 1:05"
            period = "Period 6a"
            var timel = "13:05:00";
            classis = false;
            ...
            bmessage = "Period 6b (MS Free Period) - 1:10 to 1:40"
            period = "Period 6b"
            var timel = "13:40:00";
            classis = false;
