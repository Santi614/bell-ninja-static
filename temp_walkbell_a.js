function temp_walkbell_a() {
    ...
    function getsch() {
        ...
        var timex = chour + "." + cminute;
            ...
            if (n == 2020) {
                dayweek = "School March - Schedule Accomodation (High School)"
                ...
                if (timex >= 1.00 && timex < 8.00) {
                    ...
                    bmessage = "Period 5A (Class) - 11:36 to 12:06"
                    period = "Period 5A"
                    var timel = "12:06:00";
                    classis = false;
                    ...
                    bmessage = "Period 5B (Study Hall) - 12:11 to 12:41"
                    period = "Period 5B"
                    var timel = "12:41:00";
                    classis = false;
                    ...
                    bmessage = "Period 6A (Either Lunch or Study Hall) 12:46 PM to 1:16 PM"
                    period = "Period 6A"
                    var timel = "13:16:00";
                    classis = true;
                    ...
                    bmessage = "Period 6B (Either Lunch or Study Hall) - 1:21 PM to 1:51 PM"
                    period = "Period 6B"
                    var timel = "13:51:00";
                    classis = true;
